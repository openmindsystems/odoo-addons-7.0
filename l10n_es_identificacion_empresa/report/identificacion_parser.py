...
class report_datos_identificacion(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_datos_identificacion, self).__init__(cr, uid, name, context)
        ...
        self.localcontext.update(
                                 {
                                  ...
                                  'adopcionConjunta': self._check_adopcion_conjunta,
    ...
    def _check_adopcion_conjunta(self, adopcion, selected):
        if(str(adopcion) == str(selected)):
            return 'X'
        else:
            return ''
...
report_sxw.report_sxw('report.report.datos.generales.identificacion.pyme', 'res.company.datos.generales.identificacion',
      'l10n_es_identificacion_empresa/report/identificacion_pyme.odt', parser=report_datos_identificacion, header=False)