...
class report_datos_identificacion_normal(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_datos_identificacion_normal, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.report.datos.generales.identificacion.normal', 'res.company.datos.generales.identificacion',
      'l10n_es_identificacion_empresa/report/identificacion_normal.odt', parser=report_datos_identificacion_normal, header=False)