...
class report_balance_telematic(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_balance_telematic, self).__init__(cr, uid, name, context)
        #En cada página se tienen que mostrar un rango de cuentas determinadas
        self._behave_first = [11000,11100,11200,11300,11400,11500,11600,11700,12000,12200,12300,12380,12381,12382,12370,12390,12400,12500,12600,12700,10000]
        self._behave_second = [20000,21000,21100,21110,21120,21300,21400,21500,21600,21700,21800,22000,23000,31000,31100,31200,31220,31230,31290,31300,31400,31500,31600,31700]
        self._behave_third = [32000,32200,32300,32320,32330,32390,32400,32500,32580,32581,32582,32590,32600,32700,30000]        
...
report_sxw.report_sxw('report.report.account.balance.reporting.spanish', 'account.balance.reporting',
      'addons/l10n_es_account_balance_report_telematic/report/balance_pyme_telematic_report.odt', parser=report_balance_telematic, header=False)