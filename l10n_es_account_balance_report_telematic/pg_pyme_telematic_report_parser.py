...
class report_pg_telematic(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_pg_telematic, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.report.account.pg.reporting.spanish', 'account.balance.reporting',
      'addons/l10n_es_account_balance_report_telematic/report/pg_pyme_telematic_report.odt', parser=report_pg_telematic, header=False)